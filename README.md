<p align="center">
  ...
  <p>This repository contains data for obtainable and unobtainable Genshin Impact TCG cards.</p>
  ...
  <p>Clone the repository and deploy the API on a server like:</p>
  <p align="center">
  ...
  {
    "Name": "Shenhe",
    "ImgLink": "https://genshin-tcg-card-api.vercel.app/random",
    "Source": "Genshin Impact",
    "Faction": "Liyue",
    "Element": "Cryo"
  }
```
<p>Once you get the base URL, use:</p>
